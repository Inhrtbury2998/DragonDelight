...
public enum ModItemEnum {
    // 基础物品
    ROAST_FISH_WITH_GOLD_FOIL("roast_fish_with_gold_foil",
            props -> new BlockItem(ModBlocks.ROAST_FISH_WITH_GOLD_FOIL.get(), props), p -> p),
    FEAST_OF_VICTORY("feast_of_victory",
            props -> new BlockItem(ModBlocks.FEAST_OF_VICTORY.get(), props), p -> p),
    ...
    MOSS_PIE("moss_pie",
            props -> new BlockItem(ModBlocks.MOSS_PIE.get(), props), p -> p),
    SLICE_OF_MOSS_PIE("slice_of_moss_pie", p -> p),
    BLOSSOM_PIE("blossom_pie",
            props -> new BlockItem(ModBlocks.BLOSSOM_PIE.get(), props), p -> p),
    SLICE_OF_BLOSSOM_PIE("slice_of_blossom_pie", p -> p),
    LUMINOUS_PIE("luminous_pie",
            props -> new BlockItem(ModBlocks.LUMINOUS_PIE.get(), props), p -> p),
    SLICE_OF_LUMINOUS_PIE("slice_of_luminous_pie", p -> p),
    VOLCANIC_EGG("volcanic_egg", p -> p),
    RED_HEAT_SANDWICH("red_heat_sandwich", p -> p),
    BEGGARS_RABBIT("beggars_rabbit",
            props -> new BlockItem(ModBlocks.BEGGARS_RABBIT.get(), props), p -> p),
    BEGGARS_RABBIT_COOKED("beggars_rabbit_cooked",
            props -> new BlockItem(ModBlocks.BEGGARS_RABBIT_COOKED.get(), props), p -> p),
    ...
    ROYAL_LUNCHBOX("royal_lunchbox", p -> p.food(ModFoods.ROYAL_LUNCHBOX)),
    ROYAL_FOOD("royal_food", p -> p.food(ModFoods.ROYAL_FOOD)),
    ...
    COOKED_HUMAN_MEAT("cooked_human_meat", p -> p.food(ModFoods.COOKED_HUMAN_MEAT)),
